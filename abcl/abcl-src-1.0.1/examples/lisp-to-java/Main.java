...
public class Main {
	...
	public static void main(String[] argv) {
				...
				try {
					...
					Interpreter interpreter = Interpreter.createDefaultInstance(argv);
					...
					org.armedbear.lisp.Package defaultPackage = Packages
							.findPackage("CL-USER");
					Symbol voidsym = defaultPackage
							.findAccessibleSymbol("VOID-FUNCTION");
					Function voidFunction = (Function) voidsym
							.getSymbolFunction();
